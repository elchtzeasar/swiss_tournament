module ActsAsMatch
  ...
  module InstanceMethods
    ...
    def point_difference
      participation1 = Participation.find(:first, :conditions => {
                                            :player_id => player1_id,
                                            :tournament_id => tournament_id })
      participation2 = Participation.find(:first, :conditions => {
    ...
    def is_between(received_player1, received_player2)
      received_player1 = received_player1.id if received_player1.is_a? Player
      received_player2 = received_player2.id if received_player2.is_a? Player
